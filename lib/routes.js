...
Router.route('/test', function() {
  ...
  // var text = 'request 10 rue desaix paris / 10 avenue foch paris';
  ...
  Meteor.call('getPriceEstimates',geoLoc.starting, geoLoc.ending, function(error, success) {
        if (success){
